...
class MMFNet_ProcSystem(Base_ProcSystem):
    def __init__(self, name, device=torch.device("cuda:0" if torch.cuda.is_available() else "cpu"), loss_gamma=2, init_lr=1e-4, decay_steps=5, decay_gamma=0.1):
        super().__init__()
        self.name = name
        ...
        self.criterion = FocalLoss(alpha=0.3, gamma=loss_gamma)
...
if __name__ == "__main__":
    for random_seed in range(5):
        ...
        ProcSystem = MMFNet_ProcSystem(name="MMFNet_FocalLoss")
