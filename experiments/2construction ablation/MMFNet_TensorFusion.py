...
class MMFNet_TF(nn.Module):
    def __init__(self):
        super().__init__()
        self.emb = nn.Sequential(
                        nn.Linear(6*128,1024),
                        nn.ReLU(),
                        nn.Linear(1024,512),
                        nn.ReLU(),
                        nn.Linear(512,128),
...
if __name__ == "__main__":
    for random_seed in range(5):
        ...
        ProcSystem = MMFNet_ProcSystem(eps=0.2, name="MMFNet_TensorFusion")
