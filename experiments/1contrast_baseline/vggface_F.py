...
from utils.DL_load_data import VGG_dataset, dl_load_data, split_test_verification
...
class Vggface_F_ProcSystem(Base_ProcSystem):
...
if __name__ == "__main__":
    for random_seed in range(7, 10):
        ...
        params_path = f"./model_params/vggface/vggface_{random_seed}.params"
        ...
        ProcSystem = Vggface_F_ProcSystem()
