...
from utils.DL_load_data import ArcFace_dataset, dl_load_data, irregular_samples_split
...
class ArcFace_F_ProcSystem(Base_ProcSystem):
    def __init__(self, name, device=DEVICE, eps=0.2, init_lr=1e-4, decay_steps=5, decay_gamma=0.1):
        super(ArcFace_F_ProcSystem, self).__init__()
        self.name = name
...
if __name__ == "__main__":
    for random_seed in range(5):
        ...
        ProcSystem = ArcFace_F_ProcSystem(eps=0.2, name="ArcFace_F_FringeLoss")
