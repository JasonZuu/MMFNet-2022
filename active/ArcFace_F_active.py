...
from utils.DL_load_data import Xy_Dataset_ArcFace, X_Dataset_ArcFace
...
class ArcFace_F_active_PS(Base_ProcSystem):
    def __init__(self,
                name, 
                eps=0.2,
    ...
    def output(self, X):
        ...
        self.frame.eval()
        self.adaptive_module.eval()
        Output_dataset = X_Dataset_ArcFace(X)
...
if __name__ == "__main__":
    ProcSystem = ArcFace_F_active_PS(name="MMFNet_Softmax")
