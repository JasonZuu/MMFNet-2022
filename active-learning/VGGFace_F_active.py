...
from utils.DL_load_data import X_Dataset_VGGFace, Xy_Dataset_VGGFace
...
class VGGFace_F_active_PS(Base_ProcSystem):
    def __init__(self,
                name, 
                eps=0.2,
    ...
    def output(self, X):
        ...
        self.frame.eval()
        self.adaptive_module.eval()
        Output_dataset = X_Dataset_VGGFace(X)
...
if __name__ == "__main__":
    ProcSystem = VGGFace_F_active_PS(name="MMFNet")
    i_epoch = 8
