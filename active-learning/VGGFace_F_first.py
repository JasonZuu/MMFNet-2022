...
from vggface.vgg_face import VGGFace
...
from utils.DL_load_data import Xy_Dataset_VGGFace
...
class VGGFace_F_first_PS(Base_ProcSystem):
    def __init__(self,
                name, 
                eps=0.2,
        ...
        self.extractor = VGGFace()
        self.extractor.load_weights()
        self.extractor.to(device)
        self.frame = VGGFace_F(out_planes=512)
    ...
    def train(self, X, y, save_path, debug_interval=100):
        ...
        Train_dataset = Xy_Dataset_VGGFace(X_train, y_train)
        Train_loader = DataLoader(dataset=Train_dataset,
                                    batch_size=self.batch_size,
                                    shuffle=True) 
        Very_dataset = Xy_Dataset_VGGFace(X_very, y_very)
    ...
    def test(self, X_test, y_test):
        ...
        self.frame.eval()
        self.adaptive_module.eval()
        Test_dataset = Xy_Dataset_VGGFace(X_test, y_test)
...
if __name__ == "__main__":
    ProcSystem = VGGFace_F_first_PS(name="MMFNet_Softmax")
